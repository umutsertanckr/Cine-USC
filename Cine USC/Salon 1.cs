...
namespace Cine_USC
{
    public partial class Salon_1 : Form
    {
       ...
       void koltuk()
        ...
        private void Salon_1_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            calistir = "Select *from Salon_1";
            goster();
            calistir = "Select *from s1_koltuk";
            koltuk();
            durum();
        }
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (dt_sk1.Rows[0]["Koltuk_No"].ToString() == "-1-" && dt_sk1.Rows[0]["Koltuk_Durumu"].ToString() == b)
            {
                ...
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-1-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-1-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-2-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox2_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-2-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-3-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox3_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-3-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-4-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox4_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-4-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-5-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox5_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-5-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox6_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-6-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox6_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-6-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox7_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-7-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox7_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-7-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-8-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox8_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-8-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox9_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-9-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox9_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-9-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-10-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox10_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-10-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox11_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-11-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox11_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-11-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox12_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-12-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox12_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-12-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox13_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-13-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox13_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-13-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox14_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-14-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox14_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-14-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox15_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-15-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox15_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-15-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox16_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-16-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox16_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-16-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox17_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-17-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox17_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-17-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox18_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-18-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox18_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-18-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox19_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-19-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox19_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-19-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox20_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-20-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox20_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-20-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox21_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-21-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox21_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-21-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox22_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-22-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox22_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-22-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox23_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-23-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox23_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-23-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox24_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + d + "'Where Koltuk_No= '-24-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void pictureBox24_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "Update s1_koltuk Set Koltuk_Durumu = '" + b + "'Where Koltuk_No= '-24-'";
                kom.ExecuteNonQuery();
                kom.Dispose();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                kom.Connection = bagla;
                kom.CommandText = "insert into Salon_1 (Adı_Soyadı,Koltuk_Numarası) values (" +
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            excel.SetCellValue(1, 2, "Salon 1");
            int ek = 3;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    kom.Connection = bagla;
                    kom.CommandText = "delete from Salon_1 where Referans_Num=" + dataGridView1.CurrentRow.Cells["Referans_Num"].Value +"";
                    kom.ExecuteNonQuery();
                    kom.Dispose();
                    calistir = "select * from Salon_1";
